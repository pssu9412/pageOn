                    ...
                    <div class="topbar">
                        <div class="topbar-menu d-flex align-items-center gap-1">
                            ...
                            <div class="logo-box">
                                ...
                                <a href="index.html" class="logo-light">
                                    <img src="${contextPath}/assets/images/pageon/logo-gray.jpeg" alt="logo" class="logo-lg">
                                    <img src="${contextPath}/assets/images/pageon/logo-gray.jpeg" alt="logo" class="logo-sm">
                                ...
                                <a href="index.html" class="logo-dark">
                                    <img src="${contextPath}/assets/images/pageon/logo-gray.jpeg" alt="dark logo" class="logo-lg">
                                    <img src="${contextPath}/assets/images/pageon/logo-gray.jpeg" alt="logo" class="logo-sm">
                                    <!-- <img src="${contextPath}/assets/images/logo-sm.png" alt="small logo" class="logo-sm"> -->
                                </a>
                            </div>
                        ...
                        <div class="topbar-menu d-flex flex-column align-items-center">
                            ...
                            <div class="topbar-right-bottom">                                
                                ...
                                <ul class="topbar-menu yj-topbar-menu d-flex align-items-center">
