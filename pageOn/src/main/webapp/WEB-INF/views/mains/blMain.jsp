				...
				<div class="container-fluid">
					...
					<div class="row">
						<div id="event-carousel">
							<div class="event-carousel-item">
								<img src="assets/images/pageon/event_banner_ex.png">
							</div>
							<div class="event-carousel-item">
								<img class="d-block img-fluid"
									src="assets/images/small/img-2.jpg" alt="Second slide">
							</div>
							<div class="event-carousel-item">
								<img src="assets/images/pageon/event_banner_ex.png">
							</div>
					...
					<div class="row works-slide new-works">
						...
						<div class="slide-wrapper">
							...
							<div class="card work-card">
								<div class="thumbnail-wrap">
									<img class="card-img-top"
										src="assets/images/pageon/before_adult.png">
									<!-- 성인 badge -->
							...
							<div class="card work-card">
								<img class="card-img-top"
									src="assets/images/pageon/rofan_ex2.png">
								<div class="card-body">
							...
							<div class="card work-card">
								<img class="card-img-top"
									src="assets/images/pageon/modern_romance_ex.png">
								<div class="card-body">
							...
							<div class="card work-card">
								<img class="card-img-top"
									src="assets/images/pageon/fantasy_ex.png">
								<div class="card-body">
							...
							<div class="card work-card">
								<img class="card-img-top"
									src="assets/images/pageon/Wnxia_ex.png">
								<div class="card-body">
							...
							<div class="card work-card">
								<img class="card-img-top" src="assets/images/pageon/bl_ex.png">
								<div class="card-body">
							...
							<div class="card work-card">
								<img class="card-img-top" src="assets/images/pageon/gl_ex.png">
								<div class="card-body">
							...
							<div class="card work-card">
								<img class="card-img-top"
									src="assets/images/pageon/rofan_ex1.png">
								<div class="card-body">
							...
							<div class="card work-card">
								<img class="card-img-top"
									src="assets/images/pageon/oriental_rofan_ex.png">
								<div class="card-body">
